...
myKeys =
    ...
    -- KB_GROUP Run Prompt
        , ("M-S-<Return>", spawn "rofi -show combi") -- Dmenu

    -- KB_GROUP Other Dmenu Prompts
    -- In Xmonad and many tiling window managers, M-p is the default keybinding to
    -- launch dmenu_run, so I've decided to use M-p plus KEY for these dmenu scripts.
        , ("M-p r", spawn "rofi -show run")
        , ("M-p s", spawn "rofi -show ssh")
        , ("M-p a", spawn "rofi -show drun")
        , ("M-p w", spawn "rofi -show window")
        , ("M-p e", spawn "rofimoji")
    ...
    -- KB_GROUP Emacs (SUPER-e followed by a key)
        ...
        , ("M-e a", spawn (myEmacs ++ ("--eval '(emms)' --eval '(emms-play-directory-tree \"/mnt/plex/Music/\")'")))
